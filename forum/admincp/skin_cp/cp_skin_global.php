...
$IPBHTML .= <<<HTML
	...
	<div id='footer' class='clear'>
		<a href='http://anonym.to?http://www.invisionpower.com'>IP.Board 3</a> &copy; {$year} IPS, Inc. &nbsp;&nbsp;|&nbsp;&nbsp; <a href='http://anonym.to?http://www.invisionpower.com/clients/' target='_blank' title='{$this->lang->words['gl_getsupport_title']}'>{$this->lang->words['gl_getsupport']}</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href='http://anonym.to?http://community.invisionpower.com/index.php?app=ccs' target='_blank' title='{$this->lang->words['gl_resources_title']}'>{$this->lang->words['gl_resources']}</a> &nbsp;&nbsp;|&nbsp;&nbsp; <a href='http://anonym.to?http://forumvolt.org' target='_blank' title='Visit ForumVolt'>Nulled By Skreamzja @ ForumVolt.org</a>
HTML;
