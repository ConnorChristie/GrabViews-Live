...
HTML;
	...
	{
		$IPBHTML .= <<<HTML
		<li><a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=mandrill_dashboard' target='_blank'><img src='{$this->settings['skin_acp_url']}/images/icons/cog.png' alt='' /> {$this->lang->words['mandrill_dashboard']}</a></li>
HTML;
	}
	$IPBHTML .= <<<HTML
	</ul>
...
$apikeydesc = sprintf( $this->lang->words['mandrill_api_key_desc'], "<a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=mandrill_dashboard' target='_blank'>{$this->lang->words['mandrill_dashboard']}</a>" );
...
<div class='information-box'>
	...
	<br /><br />
	<a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=mandrill_signup' target='_blank'>{$this->lang->words['mandrill_signup']}</a>
</div>
<br />
