...
class enhancements_members_spammonitoring
{
	...
	public function __construct( $registry )
	{
		...
		$this->message = "<a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=spamserviceinfo' target='_blank'>{$registry->getClass('class_localization')->words['enhancements_spammonitoring_help']}</a>";
