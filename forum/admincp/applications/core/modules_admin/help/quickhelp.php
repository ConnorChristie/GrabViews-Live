...
class admin_core_help_quickhelp extends ipsCommand
{
	...
	private function _redirect( $id )
	{
		...
		{
			case 'docs':
				$url = "http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=docs-ipb";
			break;

			case 'resources':
				$url = "http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=resources";
			break;
			
			case 'contact':
				$url = "http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=contact";
			break;
			
			case 'features':
				$url = "http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=suggestfeatures";
			break;
			
			case 'bugs':
				$url = "http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=bugs";
			break;
			
			default:
			case 'support':
				$url = "http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=support";
			break;
		}
