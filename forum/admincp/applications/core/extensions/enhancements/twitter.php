...
class enhancements_core_twitter
{
	...
	public function __construct( $registry )
	{
		...
		$this->message = '<a href="http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=twitter" target="_blank">' . ipsRegistry::getClass('class_localization')->words['enhancements_twitter_help'] . '</a>';
	}
}