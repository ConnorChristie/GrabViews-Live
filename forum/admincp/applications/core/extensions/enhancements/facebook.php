...
class enhancements_core_facebook
{
	...
	public function __construct( $registry )
	{
		...
		$this->message = '<a href="http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=facebook" target="_blank">' . ipsRegistry::getClass('class_localization')->words['enhancements_facebook_help'] . '</a>';
	}
}