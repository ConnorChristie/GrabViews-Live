...
$IPBHTML .= <<<EOF
    <ul id='links'>
        ...
        <li><img src='{$this->registry->output->imageUrl}/link.gif' align='absmiddle' /> <a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=clientarea'>Client Area</a></li>
        <li><img src='{$this->registry->output->imageUrl}/link.gif' align='absmiddle' /> <a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=docs-ipb'>Documentation</a></li>
        <li><img src='{$this->registry->output->imageUrl}/link.gif' align='absmiddle' /> <a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=forums'>IPS Company Forum</a></li>
    </ul>
EOF;
...
$IPBHTML .= <<<EOF
	...
	<fieldset>
     <legend>License Key</legend>
		<table style='width: 100%; border: 0px; padding:0px' cellspacing='0'>
	      ...
	      <tr>
	          <td colspan='2'><span style='color: gray'>Entering your license key <span style='font-weight:bold'>is optional</span> but doing so entitles you to <a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=license' target='_blank'>additional features and benefits</a>.</span></td>
	      </tr>
	  	</table>
	 </fieldset>
	 <br />
	...
	<div class='message unspecific note'>
		<a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=lkey' target='_blank'>How to locate your license key</a>
	</div>
...
if( $text == 'upgrade' )
{
	$IPBHTML .= <<<EOF
	<div class='message unspecific note'>
		If you are not comfortable performing the upgrade yourself, please stop now and submit a <a href='http://anonym.to?http://invisionpower.com/clients'>technical support ticket</a> so that our technicians can perform the upgrade for you.
		<br /><br />
...
$IPBHTML .= <<<EOF
    <div class='message unspecific note'>
    	If you need help using this installer, please see our <a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=installation-guide' target='_blank'><b>installation guide</b></a>.
    </div>
</div>
<br />
<div class='message unspecified'>
...
{
	$IPBHTML .= <<<EOF
						<li><a href='http://anonym.to?http://external.ipslink.com/ipboard30/landing/?p=installation-guide' target='_blank'><b>Installation Guide</b></a></li>
EOF;
}
