...
{
$count_50bed18d907abc394d46c6fdb418efcf = is_array($this->functionData['forward_form']) ? count($this->functionData['forward_form']) : 0;
$this->functionData['forward_form'][$count_50bed18d907abc394d46c6fdb418efcf]['title'] = $title;
$this->functionData['forward_form'][$count_50bed18d907abc394d46c6fdb418efcf]['text'] = $text;
$this->functionData['forward_form'][$count_50bed18d907abc394d46c6fdb418efcf]['lang'] = $lang;
$this->functionData['forward_form'][$count_50bed18d907abc394d46c6fdb418efcf]['captchaHTML'] = $captchaHTML;
$this->functionData['forward_form'][$count_50bed18d907abc394d46c6fdb418efcf]['msg'] = $msg;
}
					...
					<li class='ipsField clear'>
						...
						<p class='ipsField_content'>
							<select name='lang' class='input_select' id='to_lang'>
								".$this->__f__fd639a48d1a47a36efb00bf6a7699c1d($title,$text,$lang,$captchaHTML,$msg)."							</select>
						</p>
					</li>
				")) . "
				<li class='ipsField clear'>
...
function __f__fd639a48d1a47a36efb00bf6a7699c1d($title="",$text="",$lang="", $captchaHTML='', $msg='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
