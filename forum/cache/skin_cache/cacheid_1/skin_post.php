...
{
$count_3b82f1d6a449c612af199d08b93db686 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_3b82f1d6a449c612af199d08b93db686]['data'] = $data;
}
...
{
$count_d4fbc2778254b3d0cf5ca31a28bd208a = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_d4fbc2778254b3d0cf5ca31a28bd208a]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_d4fbc2778254b3d0cf5ca31a28bd208a]['form'] = $form;
}
...
{
$count_9ae61d0d94caba93b3bd7368b4f3af51 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_9ae61d0d94caba93b3bd7368b4f3af51]['data'] = $data;
}
...
{
$count_8e725298e8f5ffb5bb54ff6119dc7b60 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_8e725298e8f5ffb5bb54ff6119dc7b60]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__a8137884959379ce866a7a417d4b1472($posts)."") : ("")) . "
<p class='submit'>
...
function __f__a8137884959379ce866a7a417d4b1472($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_82dbd5f7b6c3b971ae7675c0002cdbce = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_82dbd5f7b6c3b971ae7675c0002cdbce]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_82dbd5f7b6c3b971ae7675c0002cdbce]['type'] = $type;
$this->functionData['uploadForm'][$count_82dbd5f7b6c3b971ae7675c0002cdbce]['stats'] = $stats;
$this->functionData['uploadForm'][$count_82dbd5f7b6c3b971ae7675c0002cdbce]['id'] = $id;
$this->functionData['uploadForm'][$count_82dbd5f7b6c3b971ae7675c0002cdbce]['forum_id'] = $forum_id;
}
