...
{
$count_a323de72c4fc498c66462641696acc87 = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_a323de72c4fc498c66462641696acc87]['r'] = $r;
$this->functionData['comment'][$count_a323de72c4fc498c66462641696acc87]['parent'] = $parent;
$this->functionData['comment'][$count_a323de72c4fc498c66462641696acc87]['settings'] = $settings;
}
...
{
$count_cf130b1e6948f13e5c19ece3264ab920 = is_array($this->functionData['commentHidden']) ? count($this->functionData['commentHidden']) : 0;
$this->functionData['commentHidden'][$count_cf130b1e6948f13e5c19ece3264ab920]['r'] = $r;
$this->functionData['commentHidden'][$count_cf130b1e6948f13e5c19ece3264ab920]['parent'] = $parent;
$this->functionData['commentHidden'][$count_cf130b1e6948f13e5c19ece3264ab920]['settings'] = $settings;
}
...
{
$count_352a1906462b7223fe3c7dd569f50287 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_352a1906462b7223fe3c7dd569f50287]['comments'] = $comments;
$this->functionData['commentsList'][$count_352a1906462b7223fe3c7dd569f50287]['settings'] = $settings;
$this->functionData['commentsList'][$count_352a1906462b7223fe3c7dd569f50287]['pages'] = $pages;
$this->functionData['commentsList'][$count_352a1906462b7223fe3c7dd569f50287]['parent'] = $parent;
$this->functionData['commentsList'][$count_352a1906462b7223fe3c7dd569f50287]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__a999947fc5c4cce7c5e148b3b6552465($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__a999947fc5c4cce7c5e148b3b6552465($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_a13214a29f930ae8571235f1001263f8 = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_a13214a29f930ae8571235f1001263f8]['comment'] = $comment;
$this->functionData['form'][$count_a13214a29f930ae8571235f1001263f8]['parent'] = $parent;
$this->functionData['form'][$count_a13214a29f930ae8571235f1001263f8]['editor'] = $editor;
$this->functionData['form'][$count_a13214a29f930ae8571235f1001263f8]['settings'] = $settings;
$this->functionData['form'][$count_a13214a29f930ae8571235f1001263f8]['errors'] = $errors;
$this->functionData['form'][$count_a13214a29f930ae8571235f1001263f8]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
