...
{
$count_12d42edcc1d1079a7dcd63c5afec18d3 = is_array($this->functionData['ajaxSharePost']) ? count($this->functionData['ajaxSharePost']) : 0;
$this->functionData['ajaxSharePost'][$count_12d42edcc1d1079a7dcd63c5afec18d3]['topic'] = $topic;
$this->functionData['ajaxSharePost'][$count_12d42edcc1d1079a7dcd63c5afec18d3]['post'] = $post;
$this->functionData['ajaxSharePost'][$count_12d42edcc1d1079a7dcd63c5afec18d3]['url'] = $url;
$this->functionData['ajaxSharePost'][$count_12d42edcc1d1079a7dcd63c5afec18d3]['sharelinks'] = $sharelinks;
}
...
{
$count_7e99fbe99e8345cea788418035b76934 = is_array($this->functionData['announcement_show']) ? count($this->functionData['announcement_show']) : 0;
$this->functionData['announcement_show'][$count_7e99fbe99e8345cea788418035b76934]['announce'] = $announce;
$this->functionData['announcement_show'][$count_7e99fbe99e8345cea788418035b76934]['author'] = $author;
}
...
{
$count_eb15cc6a0301670d4928c25777cf08f1 = is_array($this->functionData['archiveStatusMessage']) ? count($this->functionData['archiveStatusMessage']) : 0;
$this->functionData['archiveStatusMessage'][$count_eb15cc6a0301670d4928c25777cf08f1]['topic'] = $topic;
$this->functionData['archiveStatusMessage'][$count_eb15cc6a0301670d4928c25777cf08f1]['forum'] = $forum;
}
...
{
$count_cb97c262679bfa810698942c2c4f3e82 = is_array($this->functionData['hookFacebookLike']) ? count($this->functionData['hookFacebookLike']) : 0;
}
...
{
$count_da199f19aa8f9b90fba68307ccda46f7 = is_array($this->functionData['likeSummaryContents']) ? count($this->functionData['likeSummaryContents']) : 0;
$this->functionData['likeSummaryContents'][$count_da199f19aa8f9b90fba68307ccda46f7]['data'] = $data;
$this->functionData['likeSummaryContents'][$count_da199f19aa8f9b90fba68307ccda46f7]['relId'] = $relId;
$this->functionData['likeSummaryContents'][$count_da199f19aa8f9b90fba68307ccda46f7]['opts'] = $opts;
}
...
{
$count_b06e232ef3dad165902aec4a54ef0fea = is_array($this->functionData['pollDisplay']) ? count($this->functionData['pollDisplay']) : 0;
$this->functionData['pollDisplay'][$count_b06e232ef3dad165902aec4a54ef0fea]['poll'] = $poll;
$this->functionData['pollDisplay'][$count_b06e232ef3dad165902aec4a54ef0fea]['topicData'] = $topicData;
$this->functionData['pollDisplay'][$count_b06e232ef3dad165902aec4a54ef0fea]['forumData'] = $forumData;
$this->functionData['pollDisplay'][$count_b06e232ef3dad165902aec4a54ef0fea]['pollData'] = $pollData;
$this->functionData['pollDisplay'][$count_b06e232ef3dad165902aec4a54ef0fea]['showResults'] = $showResults;
$this->functionData['pollDisplay'][$count_b06e232ef3dad165902aec4a54ef0fea]['editPoll'] = $editPoll;
}
...
<div class='general_box alt poll' id='poll_{$poll['pid']}'>
	<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=forums&amp;module=extras&amp;section=vote&amp;t={$topicData['tid']}&amp;page={$this->request['page']}&amp;do=add&amp;secure_key={$this->member->form_hash}", "public",'' ), "", "" ) . "\" name='pollForm' method=\"post\">
		...
		") : ("")) . "
		".$this->__f__1057ecf8230cc7dd0ca584f2aefacd12($poll,$topicData,$forumData,$pollData,$showResults,$editPoll)."		<fieldset class='submit'>
...
function __f__3b4c805de8748b0327c3e1cc7b2250c2($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='',$choiceID='',$choiceData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__0b1dbebb1b29e103964963c574516985($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1,$questionID='',$questionData='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
							...
							" . (($showResults) ? ("<li>
									...
									" . (($poll['poll_view_voters'] AND is_array( $choiceData['voters'] ) AND $this->settings['poll_allow_public'] AND $choiceData['votes']) ? ("
										<script type='text/javascript'>
											...
											".$this->__f__3b4c805de8748b0327c3e1cc7b2250c2($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData,$choiceID,$choiceData)."											ipb.topic.poll[ $questionID ][ $choiceID ] = { name: \"{$choiceData['choice']}\", users: users};
										</script>
									") : ("")) . "
...
function __f__1057ecf8230cc7dd0ca584f2aefacd12($poll, $topicData, $forumData, $pollData, $showResults, $editPoll=1)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $pollData as $questionID => $questionData )
	{
		...
		$_ips___x_retval .= "
			<div class='poll_question" . (($showResults) ? (" voted") : ("")) . "'>
				...
				") : ("
					<ol>
						".$this->__f__0b1dbebb1b29e103964963c574516985($poll,$topicData,$forumData,$pollData,$showResults,$editPoll,$questionID,$questionData)."					</ol>
				")) . "
			</div>
...
{
$count_17e2e9ec49cd7a07f98c687d1a9715d9 = is_array($this->functionData['post']) ? count($this->functionData['post']) : 0;
$this->functionData['post'][$count_17e2e9ec49cd7a07f98c687d1a9715d9]['post'] = $post;
$this->functionData['post'][$count_17e2e9ec49cd7a07f98c687d1a9715d9]['displayData'] = $displayData;
$this->functionData['post'][$count_17e2e9ec49cd7a07f98c687d1a9715d9]['topic'] = $topic;
$this->functionData['post'][$count_17e2e9ec49cd7a07f98c687d1a9715d9]['forum'] = $forum;
}
...
{
$count_eef9362b237ef2d96c5e70f06a31d3b9 = is_array($this->functionData['quickEditPost']) ? count($this->functionData['quickEditPost']) : 0;
$this->functionData['quickEditPost'][$count_eef9362b237ef2d96c5e70f06a31d3b9]['post'] = $post;
}
$IPBHTML .= "{$post['post']}
    {$post['attachmentHtml']}
	<br />
...
{
$count_f21ad287afe9d485599fddde60f545cc = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_f21ad287afe9d485599fddde60f545cc]['title'] = $title;
$this->functionData['show_attachment_title'][$count_f21ad287afe9d485599fddde60f545cc]['data'] = $data;
$this->functionData['show_attachment_title'][$count_f21ad287afe9d485599fddde60f545cc]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__41fef4c784414c06358ad4a5e215f3b1($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__41fef4c784414c06358ad4a5e215f3b1($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_035b22b41c6e2ab97ad9e9c7bb921ebe = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_035b22b41c6e2ab97ad9e9c7bb921ebe]['data'] = $data;
}
...
{
$count_9943527efe05752a8a43ee41f8490a7d = is_array($this->functionData['softDeletedPostBit']) ? count($this->functionData['softDeletedPostBit']) : 0;
$this->functionData['softDeletedPostBit'][$count_9943527efe05752a8a43ee41f8490a7d]['post'] = $post;
$this->functionData['softDeletedPostBit'][$count_9943527efe05752a8a43ee41f8490a7d]['sdData'] = $sdData;
$this->functionData['softDeletedPostBit'][$count_9943527efe05752a8a43ee41f8490a7d]['topic'] = $topic;
}
...
$IPBHTML = "";
$IPBHTML .= "".$this->__f__8c737a37c3ab9b98d2844123cf342c57($topic,$posts)."<br class='clear' />
...
function __f__8c737a37c3ab9b98d2844123cf342c57($topic, $posts)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_c95cee17a12c34de86afb520b96343f3 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_c95cee17a12c34de86afb520b96343f3]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_c95cee17a12c34de86afb520b96343f3]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_c95cee17a12c34de86afb520b96343f3]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_c95cee17a12c34de86afb520b96343f3]['displayData'] = $displayData;
}
...
" . (($displayData['mod_links'] AND ( $this->memberData['is_mod'] OR $this->memberData['member_id'] == $topic['starter_id'] )) ? ("<ul class='ipbmenu_content' id='topic_mod_options_menucontent'  style='display:none'>
	".$this->__f__f8fef522b294a31c644b827a9a32e352($forum,$topic,$post_data,$displayData)."	" . (($topic['topic_queuedposts'] AND $this->registry->class_forums->canQueuePosts( $forum['id'] )) ? ("
	...
	" . ((is_array( $displayData['multi_mod'] ) AND count( $displayData['multi_mod'] )) ? ("
		".$this->__f__b86e03f4885075b576497b6754aa8485($forum,$topic,$post_data,$displayData)."	") : ("")) . "
</ul>
<script type='text/javascript'>
...
" . (($this->settings['reputation_enabled'] && $this->settings['reputation_point_types'] != 'like' && $this->settings['reputation_show_content'] && $this->memberData['member_id'] != 0 && is_array($this->caches['reputation_levels'])) ? ("<ul id='rep_filter_menucontent' class='ipbmenu_content with_checks' style='display: none'>
		...
		" . ((is_array($this->caches['reputation_levels'])) ? ("
			".$this->__f__16382b49e569f506bbded9b7d742fadb($forum,$topic,$post_data,$displayData)."		") : ("")) . "
	</ul>
	<script type='text/javascript'>
...
" . ((is_array( $post_data ) AND count( $post_data )) ? ("
	<div class='ipsBox'>
		<div class='ipsBox_container' id='ips_Posts'>
			".$this->__f__aec856582e2e520575141bfbe2a1a1dc($forum,$topic,$post_data,$displayData)."		</div>
	</div>
") : ("")) . "
<hr />
...
" . ((is_array( $displayData['same_tagged'] ) and count( $displayData['same_tagged'] )) ? ("
	...
	<div class='ipsBox'>
		...
		<div class='ipsBox_container'>
			...
			".$this->__f__3a52bcdcc0d7f9211362a5376d24a23e($forum,$topic,$post_data,$displayData)."			</table>
		</div>
	</div>
") : ("")) . "
<!-- ACTIVE USERS -->
...
function __f__f8fef522b294a31c644b827a9a32e352($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b86e03f4885075b576497b6754aa8485($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__16382b49e569f506bbded9b7d742fadb($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__aec856582e2e520575141bfbe2a1a1dc($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3a52bcdcc0d7f9211362a5376d24a23e($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
