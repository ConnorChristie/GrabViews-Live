...
{
$count_7dd2d960c767eb3e2c4b0fe70f0f9f41 = is_array($this->functionData['sendReplyForm']) ? count($this->functionData['sendReplyForm']) : 0;
$this->functionData['sendReplyForm'][$count_7dd2d960c767eb3e2c4b0fe70f0f9f41]['displayData'] = $displayData;
}
$IPBHTML .= "<postingForm>
...
{
$count_2ea9e80bb229a8a4ebe90c35873662e3 = is_array($this->functionData['showConversation']) ? count($this->functionData['showConversation']) : 0;
$this->functionData['showConversation'][$count_2ea9e80bb229a8a4ebe90c35873662e3]['topic'] = $topic;
$this->functionData['showConversation'][$count_2ea9e80bb229a8a4ebe90c35873662e3]['replies'] = $replies;
$this->functionData['showConversation'][$count_2ea9e80bb229a8a4ebe90c35873662e3]['members'] = $members;
$this->functionData['showConversation'][$count_2ea9e80bb229a8a4ebe90c35873662e3]['jump'] = $jump;
}
...
<message>
	...
	".$this->__f__a51c649dac47de7fc673a6fcd76e6a74($topic,$replies,$members,$jump)."</message>";
return $IPBHTML;
}
...
{
$count_d39c91c7842f2c1ba2daf7852e413967 = is_array($this->functionData['showFolder']) ? count($this->functionData['showFolder']) : 0;
$this->functionData['showFolder'][$count_d39c91c7842f2c1ba2daf7852e413967]['messages'] = $messages;
$this->functionData['showFolder'][$count_d39c91c7842f2c1ba2daf7852e413967]['dirname'] = $dirname;
$this->functionData['showFolder'][$count_d39c91c7842f2c1ba2daf7852e413967]['pages'] = $pages;
$this->functionData['showFolder'][$count_d39c91c7842f2c1ba2daf7852e413967]['currentFolderID'] = $currentFolderID;
$this->functionData['showFolder'][$count_d39c91c7842f2c1ba2daf7852e413967]['jumpFolderHTML'] = $jumpFolderHTML;
}
$IPBHTML .= "<template>popoverMessages</template>
<messages>
	".$this->__f__7b2c58013e56a78a19e6beb2a682c4bc($messages,$dirname,$pages,$currentFolderID,$jumpFolderHTML)."</messages>";
return $IPBHTML;
}


function __f__7b2c58013e56a78a19e6beb2a682c4bc($messages, $dirname, $pages, $currentFolderID, $jumpFolderHTML)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
