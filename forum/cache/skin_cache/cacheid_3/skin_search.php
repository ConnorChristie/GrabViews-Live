...
{
$count_9a34dcda55fd936da5383e8fd7b2e75f = is_array($this->functionData['asForumTopics']) ? count($this->functionData['asForumTopics']) : 0;
$this->functionData['asForumTopics'][$count_9a34dcda55fd936da5383e8fd7b2e75f]['data'] = $data;
}
$IPBHTML .= "<searchResult>
	...
	".$this->__f__e0e617a1eb089e81dc343bc8a158e96a($data)."</searchResult>";
return $IPBHTML;
}


function __f__e0e617a1eb089e81dc343bc8a158e96a($data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_ebac1094582f1b345210b06386071650 = is_array($this->functionData['searchResults']) ? count($this->functionData['searchResults']) : 0;
$this->functionData['searchResults'][$count_ebac1094582f1b345210b06386071650]['results'] = $results;
$this->functionData['searchResults'][$count_ebac1094582f1b345210b06386071650]['titlesOnly'] = $titlesOnly;
}
$IPBHTML .= "" . ((is_array( $results )) ? ("".$this->__f__778a6bf66746f30ec57a424d30726a4f($results,$titlesOnly)."		") : ("")) . "";
return $IPBHTML;
}


function __f__778a6bf66746f30ec57a424d30726a4f($results, $titlesOnly)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
