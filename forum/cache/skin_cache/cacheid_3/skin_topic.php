...
{
$count_acadedfe6644f9afb9e5e89867fc3c0f = is_array($this->functionData['show_attachment_title']) ? count($this->functionData['show_attachment_title']) : 0;
$this->functionData['show_attachment_title'][$count_acadedfe6644f9afb9e5e89867fc3c0f]['title'] = $title;
$this->functionData['show_attachment_title'][$count_acadedfe6644f9afb9e5e89867fc3c0f]['data'] = $data;
$this->functionData['show_attachment_title'][$count_acadedfe6644f9afb9e5e89867fc3c0f]['type'] = $type;
}
$IPBHTML .= "<div id='attach_wrap' class='clearfix'>
	<h4>{$title}</h4>
	<ul>
		".$this->__f__71ba45b8d5169b120fe56fd2d2dd3fe2($title,$data,$type)."	</ul>
</div>";
return $IPBHTML;
}


function __f__71ba45b8d5169b120fe56fd2d2dd3fe2($title="",$data="",$type="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_e1dc2c9b517afa97ca645bc38aa39812 = is_array($this->functionData['Show_attachments']) ? count($this->functionData['Show_attachments']) : 0;
$this->functionData['Show_attachments'][$count_e1dc2c9b517afa97ca645bc38aa39812]['data'] = $data;
}
...
{
$count_cae7669516039b7a82e631a1b2a560b1 = is_array($this->functionData['topicViewTemplate']) ? count($this->functionData['topicViewTemplate']) : 0;
$this->functionData['topicViewTemplate'][$count_cae7669516039b7a82e631a1b2a560b1]['forum'] = $forum;
$this->functionData['topicViewTemplate'][$count_cae7669516039b7a82e631a1b2a560b1]['topic'] = $topic;
$this->functionData['topicViewTemplate'][$count_cae7669516039b7a82e631a1b2a560b1]['post_data'] = $post_data;
$this->functionData['topicViewTemplate'][$count_cae7669516039b7a82e631a1b2a560b1]['displayData'] = $displayData;
}
...
") : ("")) . "
		...
		<topic>
			...
			<posts>				
" . ((is_array( $post_data ) AND count( $post_data )) ? ("".$this->__f__3f36c3da2539043a793fd4641cd475b8($forum,$topic,$post_data,$displayData)."") : ("")) . "
			</posts>
		</topic>
	</forum>";
return $IPBHTML;
...
function __f__3f36c3da2539043a793fd4641cd475b8($forum, $topic, $post_data, $displayData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
