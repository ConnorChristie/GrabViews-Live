...
{
$count_ec60766b033c9be8fb6d1e9ed4a78ac4 = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_ec60766b033c9be8fb6d1e9ed4a78ac4]['data'] = $data;
}
...
{
$count_4dbeed71f2a0b5b1b8470b9347985e93 = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_4dbeed71f2a0b5b1b8470b9347985e93]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_4dbeed71f2a0b5b1b8470b9347985e93]['form'] = $form;
}
...
{
$count_d19d211d74fe3675b49c2073214633f7 = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_d19d211d74fe3675b49c2073214633f7]['data'] = $data;
}
...
{
$count_a5321099dc0c8748913b0f2b4ddb4de2 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_a5321099dc0c8748913b0f2b4ddb4de2]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__021221569e5d9b8bcb7fa176f6a1a012($posts)."") : ("")) . "
<p class='submit'>
...
function __f__021221569e5d9b8bcb7fa176f6a1a012($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_bdd2035ccef3736ac626317210dc2cc0 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_bdd2035ccef3736ac626317210dc2cc0]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_bdd2035ccef3736ac626317210dc2cc0]['type'] = $type;
$this->functionData['uploadForm'][$count_bdd2035ccef3736ac626317210dc2cc0]['stats'] = $stats;
$this->functionData['uploadForm'][$count_bdd2035ccef3736ac626317210dc2cc0]['id'] = $id;
$this->functionData['uploadForm'][$count_bdd2035ccef3736ac626317210dc2cc0]['forum_id'] = $forum_id;
}
