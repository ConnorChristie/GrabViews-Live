...
{
$count_2cb92828858befbbb626b4b5bd995fc1 = is_array($this->functionData['ajaxPopUpNoPermission']) ? count($this->functionData['ajaxPopUpNoPermission']) : 0;
$this->functionData['ajaxPopUpNoPermission'][$count_2cb92828858befbbb626b4b5bd995fc1]['msg'] = $msg;
}
...
{
$count_eccf3bdf9308027befa2fcc7ae184d40 = is_array($this->functionData['displayBoardOffline']) ? count($this->functionData['displayBoardOffline']) : 0;
$this->functionData['displayBoardOffline'][$count_eccf3bdf9308027befa2fcc7ae184d40]['message'] = $message;
}
...
{
$count_2c01717d23ab0a785ba24f7024e170e1 = is_array($this->functionData['displayPopUpWindow']) ? count($this->functionData['displayPopUpWindow']) : 0;
$this->functionData['displayPopUpWindow'][$count_2c01717d23ab0a785ba24f7024e170e1]['documentHeadItems'] = $documentHeadItems;
$this->functionData['displayPopUpWindow'][$count_2c01717d23ab0a785ba24f7024e170e1]['css'] = $css;
$this->functionData['displayPopUpWindow'][$count_2c01717d23ab0a785ba24f7024e170e1]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['displayPopUpWindow'][$count_2c01717d23ab0a785ba24f7024e170e1]['title'] = $title;
$this->functionData['displayPopUpWindow'][$count_2c01717d23ab0a785ba24f7024e170e1]['output'] = $output;
}
...
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
			".$this->__f__8a71687a38f499253dea875c713427d1($documentHeadItems,$css,$jsLoaderItems,$title,$output)."			" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
		...
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__7b1f8865ffe7999dd7095de8e3b8ef56($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		<!--[if lte IE 7]>
		...
		" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
			".$this->__f__666ae923d121b26fa5bff563da411051($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__3fdd23fcb37f480d821607481be027b1($documentHeadItems,$css,$jsLoaderItems,$title,$output)."		") : ("")) . "
...
function __f__8a71687a38f499253dea875c713427d1($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7b1f8865ffe7999dd7095de8e3b8ef56($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__666ae923d121b26fa5bff563da411051($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ca9a37ae37d4ff6a50dde3e0380f6a71($documentHeadItems, $css, $jsLoaderItems, $title="", $output="",$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3fdd23fcb37f480d821607481be027b1($documentHeadItems, $css, $jsLoaderItems, $title="", $output="")
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__ca9a37ae37d4ff6a50dde3e0380f6a71($documentHeadItems,$css,$jsLoaderItems,$title,$output,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_0a84761ae7f1499e6a9b142166683494 = is_array($this->functionData['Error']) ? count($this->functionData['Error']) : 0;
$this->functionData['Error'][$count_0a84761ae7f1499e6a9b142166683494]['message'] = $message;
$this->functionData['Error'][$count_0a84761ae7f1499e6a9b142166683494]['code'] = $code;
$this->functionData['Error'][$count_0a84761ae7f1499e6a9b142166683494]['ad_email_one'] = $ad_email_one;
$this->functionData['Error'][$count_0a84761ae7f1499e6a9b142166683494]['ad_email_two'] = $ad_email_two;
$this->functionData['Error'][$count_0a84761ae7f1499e6a9b142166683494]['title'] = $title;
}
...
{
$count_c421e5f4855d171e1cff6b60cb8b6a4d = is_array($this->functionData['generateTopicIcon']) ? count($this->functionData['generateTopicIcon']) : 0;
$this->functionData['generateTopicIcon'][$count_c421e5f4855d171e1cff6b60cb8b6a4d]['imgArray'] = $imgArray;
$this->functionData['generateTopicIcon'][$count_c421e5f4855d171e1cff6b60cb8b6a4d]['unreadUrl'] = $unreadUrl;
}
...
{
$count_e32f57cd8bbf95a1389fceb767b644dc = is_array($this->functionData['globalTemplateMinimal']) ? count($this->functionData['globalTemplateMinimal']) : 0;
$this->functionData['globalTemplateMinimal'][$count_e32f57cd8bbf95a1389fceb767b644dc]['html'] = $html;
$this->functionData['globalTemplateMinimal'][$count_e32f57cd8bbf95a1389fceb767b644dc]['documentHeadItems'] = $documentHeadItems;
$this->functionData['globalTemplateMinimal'][$count_e32f57cd8bbf95a1389fceb767b644dc]['css'] = $css;
$this->functionData['globalTemplateMinimal'][$count_e32f57cd8bbf95a1389fceb767b644dc]['jsModules'] = $jsModules;
$this->functionData['globalTemplateMinimal'][$count_e32f57cd8bbf95a1389fceb767b644dc]['metaTags'] = $metaTags;
$this->functionData['globalTemplateMinimal'][$count_e32f57cd8bbf95a1389fceb767b644dc]['header_items'] = $header_items;
$this->functionData['globalTemplateMinimal'][$count_e32f57cd8bbf95a1389fceb767b644dc]['items'] = $items;
$this->functionData['globalTemplateMinimal'][$count_e32f57cd8bbf95a1389fceb767b644dc]['footer_items'] = $footer_items;
$this->functionData['globalTemplateMinimal'][$count_e32f57cd8bbf95a1389fceb767b644dc]['stats'] = $stats;
}
		...
		<div id='ipbwrapper'>
			...
			<div id='footer' class='clear'>
						...
						<form action=\"" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "{$this->settings['query_string_formatted']}", "public",'' ), "", "" ) . "\" method=\"post\">
							<fieldset>
								...
								<select name=\"langid\" id='newLang'>
									".$this->__f__6924cdc4190d2e54e7c768d9bdebd17b($html,$documentHeadItems,$css,$jsModules,$metaTags,$header_items,$items,$footer_items,$stats)."								</select>
				...
				" . ((($this->memberData['userAgentKey'] == 'iphone' || $this->memberData['userAgentKey'] == 'ipodtouch') AND ! $this->member->isMobileApp) ? ("
					<div><a href=\"http://anonym.to?http://www.invisionpower.com/download/goiphone.php\">{$this->lang->words['freeiphoneapp']}</a></div>
				") : ("")) . "
			</div>
...
function __f__6924cdc4190d2e54e7c768d9bdebd17b($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_57163632e6226f180368d0a7c6028db1 = is_array($this->functionData['redirectTemplate']) ? count($this->functionData['redirectTemplate']) : 0;
$this->functionData['redirectTemplate'][$count_57163632e6226f180368d0a7c6028db1]['documentHeadItems'] = $documentHeadItems;
$this->functionData['redirectTemplate'][$count_57163632e6226f180368d0a7c6028db1]['css'] = $css;
$this->functionData['redirectTemplate'][$count_57163632e6226f180368d0a7c6028db1]['jsLoaderItems'] = $jsLoaderItems;
$this->functionData['redirectTemplate'][$count_57163632e6226f180368d0a7c6028db1]['text'] = $text;
$this->functionData['redirectTemplate'][$count_57163632e6226f180368d0a7c6028db1]['url'] = $url;
$this->functionData['redirectTemplate'][$count_57163632e6226f180368d0a7c6028db1]['full'] = $full;
}
$IPBHTML .= "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\"> 
<html xml:lang=\"en\" lang=\"en\" xmlns=\"http://www.w3.org/1999/xhtml\"> 
	<head>
		...
		<link rel=\"shortcut icon\" href='" . (($this->registry->output->isHTTPS) ? ("{$this->settings['board_url_https']}") : ("{$this->settings['board_url']}")) . "/favicon.ico' />
		" . ((is_array( $css['import'] )) ? ("
			".$this->__f__d80222263d38ac0da1795b53aeb08a40($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
			".$this->__f__41a178dfbfa382f5a803684a13a02aa2($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--[if lte IE 7]>
			<link rel=\"stylesheet\" type=\"text/css\" title='Main' media=\"screen\" href=\"{$this->settings['public_dir']}style_css/{$this->registry->output->skin['_csscacheid']}/ipb_ie.css\" />
		<![endif]-->
		...
		" . ((count($documentHeadItems)) ? ("
			".$this->__f__0980b17f77e1dddc9c7a312af7fe0edb($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full)."		") : ("")) . "
		<!--/CSS-->
		<script type='text/javascript'>
		//<![CDATA[
...
function __f__d80222263d38ac0da1795b53aeb08a40($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['import'] as $data )
...
function __f__41a178dfbfa382f5a803684a13a02aa2($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $css['inline'] as $data )
...
function __f__cc073539bbcf48782bfdf6dc88f80792($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems[ $type ] as $idx => $data )
...
function __f__0980b17f77e1dddc9c7a312af7fe0edb($documentHeadItems, $css, $jsLoaderItems, $text="",$url="", $full=false)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__cc073539bbcf48782bfdf6dc88f80792($documentHeadItems,$css,$jsLoaderItems,$text,$url,$full,$type,$idx)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_38f3240875c8ef0b560b30ea695f3828 = is_array($this->functionData['repButtons']) ? count($this->functionData['repButtons']) : 0;
$this->functionData['repButtons'][$count_38f3240875c8ef0b560b30ea695f3828]['member'] = $member;
$this->functionData['repButtons'][$count_38f3240875c8ef0b560b30ea695f3828]['data'] = $data;
}
...
<div class='likepop fixed_inner'>
	<ul class='ipsList_withminiphoto'>
		".$this->__f__781c38d32908b93b5be696c7f45aca3e($data,$relId)."	</ul>
</div>";
return $IPBHTML;
}


function __f__781c38d32908b93b5be696c7f45aca3e($data, $relId)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
$IPBHTML .= "<div>
	...
	<div class='ipsPad' style='min-height: 60px'>
		...
		") : ("".$this->__f__166bcf0d90eb10597a88e214daf866f6($reps)."		")) . "
	</div>
</div>";
return $IPBHTML;
}
...
function __f__166bcf0d90eb10597a88e214daf866f6($reps)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $reps as $r )
...
{
$count_88c5b67befd7bbf356343644017099f8 = is_array($this->functionData['tagCloud']) ? count($this->functionData['tagCloud']) : 0;
$this->functionData['tagCloud'][$count_88c5b67befd7bbf356343644017099f8]['tags'] = $tags;
}
$IPBHTML .= "<h3 class='maintitle'>{$this->lang->words['mob_tags']}</h3>
<div class='ipsBox'>
	<div class='ipsBox_container ipsPad'>
		<ul class='ipsList_inline'>
		".$this->__f__84f937b3b3e8b94450ad160bea15573f($tags)."		</ul>
	</div>
</div>";
return $IPBHTML;
}
...
function __f__84f937b3b3e8b94450ad160bea15573f($tags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_8b182aa18e34c3c750317988a7bd0509 = is_array($this->functionData['tagEntry']) ? count($this->functionData['tagEntry']) : 0;
$this->functionData['tagEntry'][$count_8b182aa18e34c3c750317988a7bd0509]['tag'] = $tag;
$this->functionData['tagEntry'][$count_8b182aa18e34c3c750317988a7bd0509]['noClass'] = $noClass;
$this->functionData['tagEntry'][$count_8b182aa18e34c3c750317988a7bd0509]['app'] = $app;
$this->functionData['tagEntry'][$count_8b182aa18e34c3c750317988a7bd0509]['section'] = $section;
}
...
{
$count_16e617225eaef696fcd80f4fb61c8d0d = is_array($this->functionData['tagPrefix']) ? count($this->functionData['tagPrefix']) : 0;
$this->functionData['tagPrefix'][$count_16e617225eaef696fcd80f4fb61c8d0d]['tag'] = $tag;
$this->functionData['tagPrefix'][$count_16e617225eaef696fcd80f4fb61c8d0d]['app'] = $app;
$this->functionData['tagPrefix'][$count_16e617225eaef696fcd80f4fb61c8d0d]['section'] = $section;
}
			...
			<div class='ipsTagBox_editor'>
				<span id='{$options['fieldId']}_addwrap'>
					" . ((!$options['isOpenSystem']) ? ("<select id='{$options['fieldId']}_tag_select' class='input_select'>
							" . ((!empty( $options['predefinedTags'] )) ? ("".$this->__f__9982c6daceb414eb4d2dd8677cd47178($tags,$options,$where)."							") : ("")) . "
						</select>") : ("
...
function __f__9982c6daceb414eb4d2dd8677cd47178($tags, $options, $where)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
