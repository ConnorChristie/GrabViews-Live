...
$this->_funcHooks['globalTemplate'] = array('showingapp','applications','didfirstappnow','navigationlink','closenavigationlink','forsuredidfirstnav','navigation','isCoreRC','hideRcForPerms','fbcenabled','isLargeTouch','isSmallTouch','canSearch','showQuickNav','viewnewcontentapp','rclink','showacplink','accessreports','notifications','messengerlink','notifications','showInboxNotify','authenticating','updateTwitter','updateFacebook','update','canUpdateStatus','userLikeLink','nobbyNoMates','bloglink','pmLink','gallerylink','nexuslink','limFacebook','limTwitter','limWindows','memberbox','brandingBar','showhomeurl','applicationsloop','hasCustomPrimaryNavigation','didfirstnav','switchnavigation','hasHeaderAd','mainpageContent','hasFooterAd','isTouchDevice','skinchangerInner','uagentlocked','skinchangerOuter','langchooser','markRead','ruleslink','siterulestitle','privvyMiddot','siteruleslink','lastvisit','isfloat','sqldebuglink','closesqldebuglink','showdebuglevel','includeLightboxDoReal');
...
$this->facebook_url = "http://facebook.com/GrabViews"; //URL of your facebook page
$this->twitter_name = "audentio"; //Your twitter username
...
$this->default_main_color = 'dimGray '; //default main color
$this->default_background_color = '#f8f8f8'; //default background color
$this->default_background_pattern = 'pattern2'; //default background pattern (check public/style_images/cubic/assets/ad_styler/imgs/bgs for all available patterns)
$this->default_link_color = '#666'; //default link color 
$this->default_link_hover_color = '#A6A6A6'; //default link hover color
$IPBHTML .= "";
return $IPBHTML;
}
...
function __f__758c3640fe48bb04e47e743dc6faffdd($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__171a69a5fc28f509840cf15566243945($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__ec09aa5f6024ece0cc832e649f62820e($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__3c867bcfb1300de730709b3b53153eb4($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__fb5f156f8d7b2071393c16fed14ebfdd($html, $documentHeadItems, $css, $jsModules, $metaTags, array $header_items, $items=array(), $footer_items=array(), $stats=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_49b6433af711f848bb3956a7d71522a3 = is_array($this->functionData['includeCSS']) ? count($this->functionData['includeCSS']) : 0;
$this->functionData['includeCSS'][$count_49b6433af711f848bb3956a7d71522a3]['css'] = $css;
}
...
" . ((is_array( $css['import'] )) ? ("" . (($this->settings['use_minify']) ? ("") : ("")) . "
	".$this->__f__5ebadc325e87cbb0b6266a0faf4626b4($css)."	" . (($this->settings['use_minify'] AND count($this->minify)) ? ("
...
" . ((is_array( $css['inline'] ) AND count( $css['inline'] )) ? ("
	".$this->__f__5937ddce004dcbd6f836aa4ea330411b($css)."") : ("")) . "
<!--[if lte IE 7]>
...
function __f__5ebadc325e87cbb0b6266a0faf4626b4($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__5937ddce004dcbd6f836aa4ea330411b($css)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_0387febf42f78b5343e857ea9ac9aca4 = is_array($this->functionData['includeFeeds']) ? count($this->functionData['includeFeeds']) : 0;
$this->functionData['includeFeeds'][$count_0387febf42f78b5343e857ea9ac9aca4]['documentHeadItems'] = $documentHeadItems;
}
$IPBHTML .= "" . ((count($documentHeadItems)) ? ("
	".$this->__f__4ccb16a6e96ffe7746f47f8cb6819113($documentHeadItems)."") : ("")) . "";
return $IPBHTML;
}


function __f__aed53436af36d433d85d5cec47f9b920($documentHeadItems,$type='',$idx='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__4ccb16a6e96ffe7746f47f8cb6819113($documentHeadItems)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $documentHeadItems as $type => $idx )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__aed53436af36d433d85d5cec47f9b920($documentHeadItems,$type,$idx)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_cc58118fae3ef44b2206a161b1ea7ff0 = is_array($this->functionData['includeJS']) ? count($this->functionData['includeJS']) : 0;
$this->functionData['includeJS'][$count_cc58118fae3ef44b2206a161b1ea7ff0]['jsModules'] = $jsModules;
}
...
{
$count_0519b6c8d228f54c9e4bac0c1e085636 = is_array($this->functionData['includeMeta']) ? count($this->functionData['includeMeta']) : 0;
$this->functionData['includeMeta'][$count_0519b6c8d228f54c9e4bac0c1e085636]['metaTags'] = $metaTags;
}
$IPBHTML .= "" . ((is_array( $metaTags ) AND count( $metaTags )) ? ("
	".$this->__f__cadd83d44b4649f4c271306dd33e1233($metaTags)."") : ("")) . "
<meta property=\"og:image\" content=\"{$this->settings['meta_imagesrc']}\"/>";
return $IPBHTML;
}


function __f__2b3b4592528729a9f2a28ddd940a7cb6($metaTags,$tag='',$id='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__cadd83d44b4649f4c271306dd33e1233($metaTags)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $metaTags as $tag => $id )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
		".$this->__f__2b3b4592528729a9f2a28ddd940a7cb6($metaTags,$tag,$id)."	
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_eecfdaf2b490f649439d78954a91aec9 = is_array($this->functionData['includeRTL']) ? count($this->functionData['includeRTL']) : 0;
}

$this->isRtlLang	= false;
$IPBHTML .= "".$this->__f__e70fab36f5e6460077d91ee81c6e68c4()."" . (($this->isRtlLang AND is_file( DOC_IPS_ROOT_PATH . '/' . PUBLIC_DIRECTORY . '/style_css/' . $this->registry->output->skin['_csscacheid'] . '/ipb_rtl.css' )) ? ("
...
function __f__e70fab36f5e6460077d91ee81c6e68c4()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_53575c7fbffc6bae6978f7d187499b77 = is_array($this->functionData['includeVars']) ? count($this->functionData['includeVars']) : 0;
$this->functionData['includeVars'][$count_53575c7fbffc6bae6978f7d187499b77]['header_items'] = $header_items;
}
...
{
$count_09cf0d2a82b1ceae0484065ace67ddd8 = is_array($this->functionData['inlineLogin']) ? count($this->functionData['inlineLogin']) : 0;
}
				...
				" . ((IPSLib::loginMethod_enabled('facebook') || IPSLib::loginMethod_enabled('twitter') || IPSLib::loginMethod_enabled('live')) ? ("<div class='ipsBox_notice'>
						<ul class='ipsList_inline'>
							...
							" . ((is_array($this->_formFields) AND count($this->_formFields)) ? ("
								".$this->__f__7a73425cc624c3d8bf5022b2d18aa87a()."							") : ("")) . "
						</ul>
					</div>") : ("")) . "
				<br />
...
function __f__7a73425cc624c3d8bf5022b2d18aa87a()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_1b5aeb76c9bdcc64aba4ed7bc7960569 = is_array($this->functionData['liveEditJs']) ? count($this->functionData['liveEditJs']) : 0;
}
...
<div class='ipsBox ipsPad'>
	...
	<form action='" . $this->registry->getClass('output')->formatUrl( $this->registry->getClass('output')->buildUrl( "app=core&module=global&section=meta&do=save", "public",'' ), "", "" ) . "' method='post'>
		...
		<table class='ipb_table'>
			".$this->__f__6c2b90756a89ac6952765c7d231ff3c0($tags,$url)."		</table>
		</div>
		<table class='ipb_table'>
			<tr>
...
function __f__6c2b90756a89ac6952765c7d231ff3c0($tags, $url)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $tags as $k => $v )
...
{
$count_dafe4700b3cbca69f7af0baf340972b3 = is_array($this->functionData['nextPreviousTemplate']) ? count($this->functionData['nextPreviousTemplate']) : 0;
$this->functionData['nextPreviousTemplate'][$count_dafe4700b3cbca69f7af0baf340972b3]['data'] = $data;
}
...
{
$count_b3a0be7a3a31540d64bcf528fce3fe84 = is_array($this->functionData['paginationTemplate']) ? count($this->functionData['paginationTemplate']) : 0;
$this->functionData['paginationTemplate'][$count_b3a0be7a3a31540d64bcf528fce3fe84]['work'] = $work;
$this->functionData['paginationTemplate'][$count_b3a0be7a3a31540d64bcf528fce3fe84]['data'] = $data;
}
$IPBHTML .= "" . (($work['pages'] > 1) ? ("<div class='pagination clearfix left " . ((!$data['showNumbers']) ? ("no_numbers") : ("")) . "'>
		...
		<ul class='ipsList_inline left pages'>
			...
			" . ((is_array( $work['_pageNumbers'] ) && count( $work['_pageNumbers'] )) ? ("
				".$this->__f__580ca5c0388975c407d29e33fe94bd0b($work,$data)."			") : ("")) . "
		</ul>
...
function __f__580ca5c0388975c407d29e33fe94bd0b($work, $data)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4de43aa3ad120bfb0f8ac37da3e15cb6 = is_array($this->functionData['quickSearch']) ? count($this->functionData['quickSearch']) : 0;
}
$IPBHTML .= "<li class=\"left_border right\">
...
function __f__1970594e68ed50e9b79448de20829681()
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__757c354f5bcc816c5aa23d3248d46dd2($links, $title='', $url='', $cssClass='topic_share left')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_43d728e7062947440be8fcc46bed19ea = is_array($this->functionData['signature_separator']) ? count($this->functionData['signature_separator']) : 0;
$this->functionData['signature_separator'][$count_43d728e7062947440be8fcc46bed19ea]['sig'] = $sig;
$this->functionData['signature_separator'][$count_43d728e7062947440be8fcc46bed19ea]['author_id'] = $author_id;
$this->functionData['signature_separator'][$count_43d728e7062947440be8fcc46bed19ea]['can_ignore'] = $can_ignore;
}
...
{
$count_60e167ecebad3d4d94d92b7076605b03 = is_array($this->functionData['userHoverCard']) ? count($this->functionData['userHoverCard']) : 0;
$this->functionData['userHoverCard'][$count_60e167ecebad3d4d94d92b7076605b03]['member'] = $member;
}
...
{
$count_a3a0e01ae1e3d62b4c7e79f7ef217e16 = is_array($this->functionData['userInfoPane']) ? count($this->functionData['userInfoPane']) : 0;
$this->functionData['userInfoPane'][$count_a3a0e01ae1e3d62b4c7e79f7ef217e16]['author'] = $author;
$this->functionData['userInfoPane'][$count_a3a0e01ae1e3d62b4c7e79f7ef217e16]['contentid'] = $contentid;
$this->functionData['userInfoPane'][$count_a3a0e01ae1e3d62b4c7e79f7ef217e16]['options'] = $options;
}
$IPBHTML .= "<div itemscope itemtype=\"http://schema.org/Person\" class='user_details'>
	...
	" . (($author['custom_fields'] != "") ? ("
		<ul class='custom_fields'>
			".$this->__f__8cf7d0efc92a1a3a45c03efdd01455ed($author,$contentid,$options)."		</ul>
	") : ("")) . "
...
function __f__0e0a07ef2c45871e981428122c6294af($author, $contentid, $options,$group='',$data='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__8cf7d0efc92a1a3a45c03efdd01455ed($author, $contentid, $options)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $author['custom_fields'] as $group => $data )
	{
		...
		$__iteratorCount++;
		$_ips___x_retval .= "
				".$this->__f__0e0a07ef2c45871e981428122c6294af($author,$contentid,$options,$group,$data)."			
";
	}
	$_ips___x_retval .= '';
	unset( $__iteratorCount );
...
{
$count_fabaa5ca9f0fe18030ee358f235c935a = is_array($this->functionData['userSmallPhoto']) ? count($this->functionData['userSmallPhoto']) : 0;
$this->functionData['userSmallPhoto'][$count_fabaa5ca9f0fe18030ee358f235c935a]['member'] = $member;
}
...
{
$count_fd0bcf5bc0955ae44a7d7986faccb474 = is_array($this->functionData['warnDetails']) ? count($this->functionData['warnDetails']) : 0;
$this->functionData['warnDetails'][$count_fd0bcf5bc0955ae44a7d7986faccb474]['warning'] = $warning;
$this->functionData['warnDetails'][$count_fd0bcf5bc0955ae44a7d7986faccb474]['canSeeModNote'] = $canSeeModNote;
}
...
<div class='ipsBox'>
	<p class='message unspecific'>
		...
		") : ("" . (($warning['wl_points']) ? ("" . (($warning['wl_expire']) ? ("" . (($warning['wl_expire_date']) ? ("
				...
				")) . "") : ("")) . "
			".$this->__f__d92096904257e8a75f72041fa86a06ff($warning,$canSeeModNote)."")) . "
	</p>
...
function __f__d92096904257e8a75f72041fa86a06ff($warning, $canSeeModNote)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
