...
{
$count_5173fa604b9c94f75ed5d7f9a08fce4b = is_array($this->functionData['comment']) ? count($this->functionData['comment']) : 0;
$this->functionData['comment'][$count_5173fa604b9c94f75ed5d7f9a08fce4b]['r'] = $r;
$this->functionData['comment'][$count_5173fa604b9c94f75ed5d7f9a08fce4b]['parent'] = $parent;
$this->functionData['comment'][$count_5173fa604b9c94f75ed5d7f9a08fce4b]['settings'] = $settings;
}
...
{
$count_a37eb0bf6b1828a2940f2f38400a8be5 = is_array($this->functionData['commentsList']) ? count($this->functionData['commentsList']) : 0;
$this->functionData['commentsList'][$count_a37eb0bf6b1828a2940f2f38400a8be5]['comments'] = $comments;
$this->functionData['commentsList'][$count_a37eb0bf6b1828a2940f2f38400a8be5]['settings'] = $settings;
$this->functionData['commentsList'][$count_a37eb0bf6b1828a2940f2f38400a8be5]['pages'] = $pages;
$this->functionData['commentsList'][$count_a37eb0bf6b1828a2940f2f38400a8be5]['parent'] = $parent;
$this->functionData['commentsList'][$count_a37eb0bf6b1828a2940f2f38400a8be5]['preReply'] = $preReply;
}
...
<div class='ipsComment_wrap' id='comment_wrap'>
	".$this->__f__8ae958118e37dc5cbf21307efb533c32($comments,$settings,$pages,$parent,$preReply)."</div>
" . (($pages) ? ("
	<div class='topic_controls'>
		{$pages}
	</div>
...
function __f__8ae958118e37dc5cbf21307efb533c32($comments, $settings, $pages, $parent, $preReply='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_6b948fda83405aba73ca6ab67509fb3e = is_array($this->functionData['form']) ? count($this->functionData['form']) : 0;
$this->functionData['form'][$count_6b948fda83405aba73ca6ab67509fb3e]['comment'] = $comment;
$this->functionData['form'][$count_6b948fda83405aba73ca6ab67509fb3e]['parent'] = $parent;
$this->functionData['form'][$count_6b948fda83405aba73ca6ab67509fb3e]['editor'] = $editor;
$this->functionData['form'][$count_6b948fda83405aba73ca6ab67509fb3e]['settings'] = $settings;
$this->functionData['form'][$count_6b948fda83405aba73ca6ab67509fb3e]['errors'] = $errors;
$this->functionData['form'][$count_6b948fda83405aba73ca6ab67509fb3e]['do'] = $do;
}
$IPBHTML .= "" . (($errors) ? ("
