...
{
$count_8341524f72f8e1ae6e892113f2ab7ddf = is_array($this->functionData['pollBox']) ? count($this->functionData['pollBox']) : 0;
$this->functionData['pollBox'][$count_8341524f72f8e1ae6e892113f2ab7ddf]['data'] = $data;
}
...
{
$count_4f73525d40a0e7e8a5f993813dc4cc6c = is_array($this->functionData['postFormTemplate']) ? count($this->functionData['postFormTemplate']) : 0;
$this->functionData['postFormTemplate'][$count_4f73525d40a0e7e8a5f993813dc4cc6c]['formData'] = $formData;
$this->functionData['postFormTemplate'][$count_4f73525d40a0e7e8a5f993813dc4cc6c]['form'] = $form;
}
...
{
$count_9eb847b63c339806ad749cdcaa20cfde = is_array($this->functionData['preview']) ? count($this->functionData['preview']) : 0;
$this->functionData['preview'][$count_9eb847b63c339806ad749cdcaa20cfde]['data'] = $data;
}
...
{
$count_4e2f45cb0ebee9701ba34861f1abb9b4 = is_array($this->functionData['topicSummary']) ? count($this->functionData['topicSummary']) : 0;
$this->functionData['topicSummary'][$count_4e2f45cb0ebee9701ba34861f1abb9b4]['posts'] = $posts;
}
...
" . ((is_array( $posts ) AND count( $posts )) ? ("
	".$this->__f__6cc02e4ee6ab9551f32bc1330403bf43($posts)."") : ("")) . "
<p class='submit'>
...
function __f__6cc02e4ee6ab9551f32bc1330403bf43($posts=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_eb98bc74b6bfca7b27409248071268c8 = is_array($this->functionData['uploadForm']) ? count($this->functionData['uploadForm']) : 0;
$this->functionData['uploadForm'][$count_eb98bc74b6bfca7b27409248071268c8]['post_key'] = $post_key;
$this->functionData['uploadForm'][$count_eb98bc74b6bfca7b27409248071268c8]['type'] = $type;
$this->functionData['uploadForm'][$count_eb98bc74b6bfca7b27409248071268c8]['stats'] = $stats;
$this->functionData['uploadForm'][$count_eb98bc74b6bfca7b27409248071268c8]['id'] = $id;
$this->functionData['uploadForm'][$count_eb98bc74b6bfca7b27409248071268c8]['forum_id'] = $forum_id;
}
