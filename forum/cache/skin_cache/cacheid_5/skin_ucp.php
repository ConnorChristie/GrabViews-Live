...
/* CACHE FILE: Generated: Fri, 26 Jul 2013 21:54:38 GMT */
...
{
$count_8a65527415976cd47616ee9ee27b7d40 = is_array($this->functionData['coreAttachments']) ? count($this->functionData['coreAttachments']) : 0;
$this->functionData['coreAttachments'][$count_8a65527415976cd47616ee9ee27b7d40]['info'] = $info;
$this->functionData['coreAttachments'][$count_8a65527415976cd47616ee9ee27b7d40]['pages'] = $pages;
$this->functionData['coreAttachments'][$count_8a65527415976cd47616ee9ee27b7d40]['attachments'] = $attachments;
}
...
<div class='row1'>	
	...
	<table class='ipb_table' summary=\"{$this->lang->words['ucp_user_attach']}\">
		<tr class='header'>
			...
			" . ((count($attachments)) ? ("
								".$this->__f__cf837f4ebd95b2a71b2baad4d10f134b($info,$pages,$attachments)."			") : ("
				<tr>
...
function __f__cf837f4ebd95b2a71b2baad4d10f134b($info="",$pages="",$attachments)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
{
$count_4fb522e906f3a2c56f6b6fabac7ddff6 = is_array($this->functionData['displayNameForm']) ? count($this->functionData['displayNameForm']) : 0;
$this->functionData['displayNameForm'][$count_4fb522e906f3a2c56f6b6fabac7ddff6]['form'] = $form;
$this->functionData['displayNameForm'][$count_4fb522e906f3a2c56f6b6fabac7ddff6]['error'] = $error;
$this->functionData['displayNameForm'][$count_4fb522e906f3a2c56f6b6fabac7ddff6]['okmessage'] = $okmessage;
$this->functionData['displayNameForm'][$count_4fb522e906f3a2c56f6b6fabac7ddff6]['isFB'] = $isFB;
}
$IPBHTML .= "" . (($okmessage != "") ? ("
...
{
$count_375cd4e9d31323a6a7c42253f590a1e8 = is_array($this->functionData['emailPasswordChangeForm']) ? count($this->functionData['emailPasswordChangeForm']) : 0;
$this->functionData['emailPasswordChangeForm'][$count_375cd4e9d31323a6a7c42253f590a1e8]['txt'] = $txt;
$this->functionData['emailPasswordChangeForm'][$count_375cd4e9d31323a6a7c42253f590a1e8]['_message'] = $_message;
$this->functionData['emailPasswordChangeForm'][$count_375cd4e9d31323a6a7c42253f590a1e8]['isFB'] = $isFB;
}
...
{
$count_73dc12439d4736e3a046f1d11eac84ca = is_array($this->functionData['field_entry']) ? count($this->functionData['field_entry']) : 0;
$this->functionData['field_entry'][$count_73dc12439d4736e3a046f1d11eac84ca]['title'] = $title;
$this->functionData['field_entry'][$count_73dc12439d4736e3a046f1d11eac84ca]['desc'] = $desc;
$this->functionData['field_entry'][$count_73dc12439d4736e3a046f1d11eac84ca]['content'] = $content;
$this->functionData['field_entry'][$count_73dc12439d4736e3a046f1d11eac84ca]['id'] = $id;
}
...
{
$count_808eb64130fb3b3d37f78c4b19cc9856 = is_array($this->functionData['membersFacebookConnect']) ? count($this->functionData['membersFacebookConnect']) : 0;
$this->functionData['membersFacebookConnect'][$count_808eb64130fb3b3d37f78c4b19cc9856]['fbuid'] = $fbuid;
$this->functionData['membersFacebookConnect'][$count_808eb64130fb3b3d37f78c4b19cc9856]['fbUserData'] = $fbUserData;
$this->functionData['membersFacebookConnect'][$count_808eb64130fb3b3d37f78c4b19cc9856]['linkedMemberData'] = $linkedMemberData;
$this->functionData['membersFacebookConnect'][$count_808eb64130fb3b3d37f78c4b19cc9856]['perms'] = $perms;
}
...
{
$count_a633fccd19ba26d8d29989de0822b545 = is_array($this->functionData['membersIgnoredUsersForm']) ? count($this->functionData['membersIgnoredUsersForm']) : 0;
$this->functionData['membersIgnoredUsersForm'][$count_a633fccd19ba26d8d29989de0822b545]['members'] = $members;
$this->functionData['membersIgnoredUsersForm'][$count_a633fccd19ba26d8d29989de0822b545]['pagination'] = $pagination;
}
...
<table class='ipb_table' summary=\"{$this->lang->words['ucp_ignored_users']}\">
	<tr class='header'>
		...
		" . ((count( $members )) ? ("".$this->__f__5bba74eb6570483a0ca5331650f9c0be($members,$pagination)."	") : ("<tr>
...
function __f__5bba74eb6570483a0ca5331650f9c0be($members, $pagination)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__d7cd0949927ac54cdf410b506aad4d70($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__7e6a8b3bc65253c00052da22234b05db($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $mon as $m )
...
function __f__0cb032d7c73fef1ba4963ec065d1a010($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $day as $d )
...
function __f__1b9b9282bb568d344b27922448a8d35c($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $year as $y )
...
function __f__870bcaeb90d956a9b2854244fa4f2697($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array(),$cgroup='',$cfields='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__f9f140957798adb628d334c9d5c5ec81($custom_fields='',$group_titles='',$day='',$mon='',$year='', $amEditor='', $times=array())
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
		...
		$_ips___x_retval .= "
			" . ((count( $cfields )) ? ("
				<fieldset class='ipsSettings_section'>
					...
					<div>
						<ul>
							".$this->__f__870bcaeb90d956a9b2854244fa4f2697($custom_fields,$group_titles,$day,$mon,$year,$amEditor,$times,$cgroup,$cfields)."						</ul>
					</div>
				</fieldset>
			") : ("")) . "
...
{
$count_b4149f970ca966af4caa56311dfdd3af = is_array($this->functionData['membersSignatureForm']) ? count($this->functionData['membersSignatureForm']) : 0;
$this->functionData['membersSignatureForm'][$count_b4149f970ca966af4caa56311dfdd3af]['editor_html'] = $editor_html;
$this->functionData['membersSignatureForm'][$count_b4149f970ca966af4caa56311dfdd3af]['sig_restrictions'] = $sig_restrictions;
$this->functionData['membersSignatureForm'][$count_b4149f970ca966af4caa56311dfdd3af]['signature'] = $signature;
}
...
{
$count_dbd18a5d215ce8c658132c5b441a9205 = is_array($this->functionData['membersTwitterConnect']) ? count($this->functionData['membersTwitterConnect']) : 0;
$this->functionData['membersTwitterConnect'][$count_dbd18a5d215ce8c658132c5b441a9205]['isConnected'] = $isConnected;
$this->functionData['membersTwitterConnect'][$count_dbd18a5d215ce8c658132c5b441a9205]['twitterUser'] = $twitterUser;
}
...
{
$count_98f402e992ce7488592eb45fbb6df8b1 = is_array($this->functionData['notificationsForm']) ? count($this->functionData['notificationsForm']) : 0;
$this->functionData['notificationsForm'][$count_98f402e992ce7488592eb45fbb6df8b1]['config'] = $config;
$this->functionData['notificationsForm'][$count_98f402e992ce7488592eb45fbb6df8b1]['emailData'] = $emailData;
}
...
<fieldset class='row1'>
	<span class='desc'><strong>{$this->lang->words['notifications_info_acp']}</strong></span>
		...
		".$this->__f__b18fa147ae3871c3b7bf8a48699f2841($config,$emailData)."		".$this->__f__b94c8debdbc2f39ece6942ca98b016b6($config,$emailData)."	</table>
</fieldset>";
return $IPBHTML;
}


function __f__c69f2b508a62766e23b10fc8775567d2($config, $emailData,$groupKey='',$group='')
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__b18fa147ae3871c3b7bf8a48699f2841($config, $emailData)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
	foreach( $this->notifyGroups as $groupKey => $group )
	{
		...
		$_ips___x_retval .= "
			...
			".$this->__f__c69f2b508a62766e23b10fc8775567d2($config,$emailData,$groupKey,$group)."							
...
{
$count_a03bab9a4c0a5a86afc884d2cbef2e5b = is_array($this->functionData['notificationsLog']) ? count($this->functionData['notificationsLog']) : 0;
$this->functionData['notificationsLog'][$count_a03bab9a4c0a5a86afc884d2cbef2e5b]['notifications'] = $notifications;
$this->functionData['notificationsLog'][$count_a03bab9a4c0a5a86afc884d2cbef2e5b]['error'] = $error;
$this->functionData['notificationsLog'][$count_a03bab9a4c0a5a86afc884d2cbef2e5b]['pages'] = $pages;
}
		...
		<table class='ipb_table' summary=\"{$this->lang->words['notifications_table_head']}\">
			<tr class='header hide'>
				...
				<th scope='col' align=\"center\" width=\"5%\" class='short'>&nbsp;</th>
						...
						".$this->__f__429bfb10574c73d38d4f1b0d0333b61a($notifications,$error,$pages)."		</table>
		<script type='text/javascript'>
...
{
$count_f9c8b3128e093c5e951779b2dd8fa31a = is_array($this->functionData['userCPTemplate']) ? count($this->functionData['userCPTemplate']) : 0;
$this->functionData['userCPTemplate'][$count_f9c8b3128e093c5e951779b2dd8fa31a]['current_tab'] = $current_tab;
$this->functionData['userCPTemplate'][$count_f9c8b3128e093c5e951779b2dd8fa31a]['html'] = $html;
$this->functionData['userCPTemplate'][$count_f9c8b3128e093c5e951779b2dd8fa31a]['tabs'] = $tabs;
$this->functionData['userCPTemplate'][$count_f9c8b3128e093c5e951779b2dd8fa31a]['current_area'] = $current_area;
$this->functionData['userCPTemplate'][$count_f9c8b3128e093c5e951779b2dd8fa31a]['errors'] = $errors;
$this->functionData['userCPTemplate'][$count_f9c8b3128e093c5e951779b2dd8fa31a]['hide_form'] = $hide_form;
$this->functionData['userCPTemplate'][$count_f9c8b3128e093c5e951779b2dd8fa31a]['maxUpload'] = $maxUpload;
}
...
" . ((count($tabs) > 1) ? ("
	<div class='maintitle ipsFilterbar clearfix'>
		<ul class='ipsList_inline'>
			".$this->__f__94204999565b711b272b9251fe82e8a8($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."		</ul>
	</div>
") : ("")) . "
<div class='ipsBox'>
	<div class='ipsLayout" . (($hasMoreTabs) ? (" ipsLayout_withleft ipsLayout_smallleft ipsVerticalTabbed") : ("")) . " clearfix usercp_body'>
		" . (($hasMoreTabs) ? ("
			<div class='ipsVerticalTabbed_tabs ipsLayout_left' id='usercp_tabs'>
				<ul>
					".$this->__f__23ae0bcf81520402bd29c8b8d4557731($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."				</ul>
			</div>
		") : ("")) . "
		<div class='" . (($hasMoreTabs) ? ("ipsVerticalTabbed_content ") : ("")) . "ipsLayout_content ipsBox_container' id='usercp_content'>
			<div class='ipsPad'>
				" . ((is_array( $errors ) AND count( $errors )) ? ("
					<p class='message error'>
						".$this->__f__372031b7321c8747d5644f6f0442c3d2($current_tab,$html,$tabs,$current_area,$errors,$hide_form,$maxUpload)."					</p>
					<br />
				") : ("")) . "
...
function __f__94204999565b711b272b9251fe82e8a8($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__23ae0bcf81520402bd29c8b8d4557731($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
...
function __f__372031b7321c8747d5644f6f0442c3d2($current_tab, $html, $tabs, $current_area, $errors=array(), $hide_form=0, $maxUpload=0)
{
	$_ips___x_retval = '';
	$__iteratorCount = 0;
